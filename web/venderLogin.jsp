...
<html>
    ...
    <body>
        ...
        <form action="venderLog" method="post">
            <div class="container">
                <div class="buttons">
                ...
                <form class="form">
                    ...
                    <div class="form-actions">
                        <button class="button" type="reset" >  <a href="Vendersignup.html"  style="text-decoration: none ">Signup</a></button>
                      
                         <button class="button" type="submit"  src="usersignup">Signup</button>
